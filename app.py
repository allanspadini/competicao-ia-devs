...
# Interface para o input do link, com sugestão de link padrão
endereco = st.text_input(
    "Insira o link de uma página com o tema do jogo que quer gerar:",
    value="https://pt.wikipedia.org/wiki/Geof%C3%ADsica"
)

# Executa o código automaticamente quando o link é inserido
if endereco:
    # Executa o restante do código apenas se o link for fornecido
    TWEAKS = {
        "URL-AyNM0": {
            "urls": []
        },
    ...
    for index, row in df.iterrows():
        ...
        # Botão para enviar a palavra adivinhada
